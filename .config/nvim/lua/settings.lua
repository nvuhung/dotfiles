...
cmd('autocmd BufNewFile,BufRead *.css set filetype=scss')
cmd('autocmd BufNewFile,BufRead *.sjs set filetype=javascript')
cmd('autocmd BufNewFile,BufRead *.mdx set filetype=markdown.mdx')
cmd('autocmd BufNewFile,BufRead *.astro set filetype=astro')
cmd('autocmd BufNewFile,BufRead *.svelte set filetype=svelte')
cmd('autocmd BufNewFile,BufRead *.prisma set filetype=prisma')
