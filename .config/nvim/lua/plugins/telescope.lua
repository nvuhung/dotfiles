return function()
  ...
  require('telescope').setup{
    defaults = {
      ...
      file_ignore_patterns = {"autoload/.*", "node_modules/.*", "plugged/.*", "android/.*", "ios/.*", "build/.*", "dist/.*", ".git/.*", "CHANGELOG.md"}, generic_sorter =  require'telescope.sorters'.get_generic_fuzzy_sorter,
      -- path_display = true,
      winblend = 0,
      border = {},
      borderchars = { '─', '│', '─', '│', '╭', '╮', '╯', '╰' },
